...
public class ChangedProductService {
    ...
    @Autowired
    public ChangedProductService(@NonNull ChangedProductRepository changedProductRepository, @NonNull AvailableProductRepository availableProductRepository, @NonNull LocationRepository locationRepository, @NonNull ProductRepository productRepository) {
